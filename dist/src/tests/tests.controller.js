...
let TestsController = class TestsController {
    ...
    findAll(status, subject) {
        if (status)
            return this.testsService.findByStatus(status);
        if (subject)
            return this.testsService.findBySubject(subject);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, test_dto_1.UpdateTestDto]),
    __metadata("design:returntype", void 0)
