...
export class QuestionBanksController {
  ...
  create(@Body() createQuestionBankDto: CreateQuestionBankDto, @UploadedFile() file?: Express.Multer.File) {
    return this.questionBanksService.create(createQuestionBankDto, file?.buffer);
  }
  ...
  update(
    ...
    return this.questionBanksService.update(id, updateQuestionBankDto, file?.buffer);
  }
